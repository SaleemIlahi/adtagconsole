...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `adtagdata`( `developer_name`,`adtag_type`, `geo`, `campaign_name`, `client`, `fcat`, `publisher`, `dims`, `status`) VALUES ('$dev_name','$adtag_type','$geo','$campaign_name','$client','$fcat','$publisher','$dims','staging')";
